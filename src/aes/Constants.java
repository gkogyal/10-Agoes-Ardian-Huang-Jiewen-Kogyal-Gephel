...
public class Constants {
    ...
    //SBOX or substitution box contains values applied to each byte. Each byte is swapped for a completley different byte in a nonlinear way, so it is unpredictable.
